...
class Message{
    ...
    public function getMessages($otherUser){
        ...
        $get_message_query = mysqli_query($this->con, "SELECT * FROM messages WHERE (user_to='$userLoggedIn' AND user_from='$otherUser') OR (user_to='$otherUser' AND user_from='$userLoggedIn')");
        ...
        foreach($convos as $username){
            ...
            $return_string .= "<a href='messages.php?u=$username'>
                                  <div class='user_found_messages'>
                                        ...
                                        <br><p id='grey' style='margin: 0;'>" . $latest_message_details[0] . $split . "</p>
                                  </div>    
                                </a>";
        }
