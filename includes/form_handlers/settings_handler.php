...
//For the update query of password
    ...
    if(md5($old_password) == $db_password){
        ...
        if($new_password_1 == $new_password_2){
            ...
            if(strlen($new_password_1) >= 5){
                ...
                $password_message = "Your password has been updated!<br><br>";
            }else{
                $password_message = "Your password should be greater or equal 5 characters<br><br>";
            }
            
        }else{
            $password_message = "Your passwords need to match!<br><br>";
        }
