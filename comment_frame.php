...
<body style="background-color: rgba(228, 228, 228, 0.41)">
        ...
        while($comment = mysqli_fetch_array($get_comments)){
            ...
            ?>
                <div class="comment_section">
                    ...
                    <a href="<?php echo $posted_by; ?>" target="_parent"><b><?php echo $user_obj->getFirstAndLastName(); ?></b></a><span style="float:right;"><?php echo $time_message; ?></span>
                    <div><?php echo $comment_body; ?></div><br>
                </div>
            <?php
        }
    }else{
