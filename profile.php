...
?>
  <style type="text/css">
   ...
   <div class="profile_main_coloumn coloumn">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="profile_post" action="profile.php" method="post">
            <div class="form-group">
                <textarea class="form-control" name="post_body">
                </textarea>
     ...
     <script>
       ...
       $(document).ready(function(){
           ...
           //orignal AJAX POST for loading posts.
           $.ajax({
           ...
           $(window).scroll(function(){
               var height = $('.posts_area').height();  //Height of DIV element.
